...
public class SCHTTP:NSObject,Error,URLSessionTaskDelegate,URLSessionDelegate{
...
//                let fil = URL(fileURLWithPath:"/Users/stan/Desktop/ccc")
//                try remoteCertificateData .write(to: fil)
